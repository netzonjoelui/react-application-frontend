...
import OrderByModel from 'netric/models/entity/OrderBy';
import SortOrderComponent from 'netric/components/advancedsearch/SortOrder';
import Controls from 'netric/components/Controls';

/**
 * Test rendering the Advanced Search Column View
 */
describe("Advanced Search Sort Order Component", () => {
    ...
    const renderedDocument = ReactTestUtils.renderIntoDocument(
      <div>
        <SortOrderComponent
          ...
          orderByDataList={[{field_name: "name", direction: "asc"}, {field_name: "title", direction: "desc"}]}
        />
      </div>
    );
